...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState(JSON.parse('{\
    ...
    "fallbackExclusionList": [\
      ["hardhat-simple-storage-fcc", ["workspace:."]]\
    ],\
    "fallbackPool": [\
    ],\
    "packageRegistryData": [\
      ...
      ["tsconfig.json", [\
        ["npm:1.0.11", {\
          "packageLocation": "./.yarn/cache/tsconfig.json-npm-1.0.11-fb93e2c6fd-f0afd7aeb2.zip/node_modules/tsconfig.json/",\
          "packageDependencies": [\
            ["tsconfig.json", "npm:1.0.11"],\
            ["inquirer", "npm:6.5.2"]\
          ],\
